...
import { Product, Order, CustomerDebt } from '../types/pos';
...
export function AdminDashboard({
  ...
  const [activeTab, setActiveTab] = useState<'menu' | 'analytics' | 'debts' | 'kitchen' | 'supabase'>('menu');
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center shadow-sm">
        ...
        <div className="flex bg-gray-100 p-1 rounded-xl gap-1 text-xs font-bold">
          <button
            ...
            className={`px-4 py-2 rounded-lg transition-all ${activeTab === 'menu' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-900'}`}
          >
            Menu & Products
          </button>
          <button
            onClick={() => setActiveTab('analytics')}
            className={`px-4 py-2 rounded-lg transition-all ${activeTab === 'analytics' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-900'}`}
          >
            Sales Analytics
          </button>
          <button
            onClick={() => setActiveTab('debts')}
            className={`px-4 py-2 rounded-lg transition-all ${activeTab === 'debts' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-900'}`}
          >
            Customer Debts
          </button>
          <button
            onClick={() => setActiveTab('kitchen')}
            className={`px-4 py-2 rounded-lg transition-all ${activeTab === 'kitchen' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-900'}`}
          >
            የኩሽና ምርት (Kitchen Tickets)
          </button>
          <button
            onClick={() => setActiveTab('supabase')}
            className={`px-4 py-2 rounded-lg transition-all ${activeTab === 'supabase' ? 'bg-emerald-600 text-white shadow-sm' : 'text-gray-500 hover:text-gray-900'}`}
          >
            Supabase BaaS
          </button>
        </div>
